...
export const copy = {
  en: {
    ...
    ui: { chooseImage: "Choose image", openCamera: "Open camera", switchCamera: "Switch camera", capture: "Capture", closeCamera: "Close camera", retake: "Retake", cameraError: "Unable to open camera. Check browser permissions.", generating: "Generating...", downloadImage: "Download Image", shareOnX: "Share on X", shareOnFacebook: "Share on Facebook", copyLink: "Copy Link", linkCopied: "Link copied!", shareText: "Just got my AI reading - surprisingly insightful! 🔮✨ Try yours:", shareTextTarot: "My AI tarot reading revealed some interesting patterns 🎴 What will your cards say?", shareTextCareer: "Got my AI career analysis - pretty accurate! 💼 Check yours:", shareTextFace: "AI analyzed my personality from my face 😮 Try it yourself:", shareTextPalm: "My palm reading shows some fascinating life patterns 🤲 Get yours:", shareTextDream: "AI decoded my dream symbols 😴💭 What do your dreams mean?" },
  ...
  zh: {
    ...
    ui: { chooseImage: "选择图片", openCamera: "开启相机", switchCamera: "切换相机", capture: "拍照", closeCamera: "关闭相机", retake: "重新拍摄/选择", cameraError: "无法启动相机，请检查浏览器权限设置。", generating: "生成中...", downloadImage: "下载图片", shareOnX: "分享到 X", shareOnFacebook: "分享到 Facebook", copyLink: "复制链接", linkCopied: "已复制！", shareText: "刚做了个AI占卜，还挺准的🔮✨ 来试试你的：", shareTextTarot: "我的AI塔罗牌解读很有意思🎴 你的牌会说什么？", shareTextCareer: "AI职业分析结果出来了，挺准💼 看看你的：", shareTextFace: "AI从我的面相分析出了性格😮 试试你的：", shareTextPalm: "手相解读发现了一些有趣的生命轨迹🤲 看看你的：", shareTextDream: "AI帮我解了个梦😴💭 你的梦是什么意思？" },
  ...
  fr: {
    ...
    ui: { chooseImage: "Choisir une image", openCamera: "Ouvrir la caméra", switchCamera: "Changer de caméra", capture: "Capturer", closeCamera: "Fermer la caméra", retake: "Reprendre", cameraError: "Impossible d'ouvrir la caméra. Vérifiez les autorisations du navigateur.", generating: "Génération...", downloadImage: "Télécharger l'image", shareOnX: "Partager sur X", shareOnFacebook: "Partager sur Facebook", copyLink: "Copier le lien", linkCopied: "Lien copié !", shareText: "Je viens de faire une lecture IA - étonnamment perspicace ! 🔮✨ Essayez :", shareTextTarot: "Ma lecture de tarot IA a révélé des motifs intéressants 🎴 Que diront vos cartes ?", shareTextCareer: "Mon analyse de carrière IA - plutôt précise ! 💼 Vérifiez :", shareTextFace: "L'IA a analysé ma personnalité 😮 Essayez :", shareTextPalm: "Ma lecture de paume montre des motifs fascinants 🤲 Obtenez :", shareTextDream: "L'IA a décodé mes symboles de rêve 😴💭 Que signifient vos rêves ?" },
  ...
  ja: {
    ...
    ui: { chooseImage: "画像を選択", openCamera: "カメラを開く", switchCamera: "カメラを切り替え", capture: "撮影", closeCamera: "カメラを閉じる", retake: "撮り直す", cameraError: "カメラを開けません。ブラウザの権限設定を確認してください。", generating: "生成中...", downloadImage: "画像をダウンロード", shareOnX: "Xでシェア", shareOnFacebook: "Facebookでシェア", copyLink: "リンクをコピー", linkCopied: "コピーしました！", shareText: "AI占いやってみた、意外と当たってる🔮✨ あなたも試してみて：", shareTextTarot: "AIタロット占いで面白いパターンが出た🎴 あなたのカードは何を言う？", shareTextCareer: "AIキャリア分析受けた、結構当たってる💼 試してみて：", shareTextFace: "AIが顔から性格分析してくれた😮 やってみて：", shareTextPalm: "手相占いで興味深い人生のパターンが見えた🤲 あなたも：", shareTextDream: "AIが夢のシンボルを解読してくれた😴💭 あなたの夢の意味は？" },
